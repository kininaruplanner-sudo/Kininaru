-- =====================================================================
-- Kininaru Planner — SAFE Bootstrap Schema
-- =====================================================================
-- This file ONLY creates tables and functions using IF NOT EXISTS.
-- It is safe to run on any database without destroying existing data.
--
-- Use this INSTEAD of schema.sql for:
--   - Fresh production deployments
--   - Running after partial deployments
--   - CI/CD pipelines
--
-- schema.sql remains for DEVELOPMENT reset only (drops all tables).
-- =====================================================================
...
create index if not exists focus_sessions_created_at_idx on public.focus_sessions(created_at);
...
create index if not exists ai_memories_user_id_idx on public.ai_memories(user_id, created_at desc);
