    ...
    if (isLogged) {
      ...
      if (data) {
        ...
        if (MILESTONES.includes(newStreak)) {
          ...
          setMilestoneHit({ title: habit?.title ?? 'Habit', days: newStreak })
                        ...
                        <div className="flex items-center justify-between gap-2">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {habit.streak > 0 && (() => {
                              ...
                              return next ? (
                                <span className="text-[10px] text-muted-foreground">{next - habit.streak}d to {next}-day streak</span>
                              ) : null
                            })()}
                            {habit.best_streak > 0 && habit.best_streak !== habit.streak && (
                              <span className="flex items-center gap-0.5 text-[10px] text-muted-foreground" title="Best streak">
