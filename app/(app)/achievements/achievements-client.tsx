...
export function AchievementsClient({ profile, tasks, focusSessions, habits }: Props) {
  ...
  const badges: Badge[] = useMemo(() => [
    ...
    {
      id: 'task_50',
      title: 'Pro de la productivité',
      description: 'Terminez 50 tâches',
      icon: Star,
      color: 'text-kin-yellow',
      bg: 'bg-kin-yellow/20',
    ...
    {
      id: 'streak_7',
      title: 'Série d\'habitudes',
      description: 'Maintenez une série de 7 jours',
      icon: Flame,
      color: 'text-kin-coral',
      bg: 'bg-kin-coral/20',
    ...
    },
    {
      ...
      icon: Trophy,
      color: 'text-kin-lavender',
      bg: 'bg-kin-lavender/20',
      unlocked: level >= 5,
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-card">
        <div>
          <h1 className="text-xl font-serif font-bold text-foreground">Succès</h1>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">Niveau {level}</p>
                </div>
              </div>
            ...
            {badges.map((badge, i) => (
              ...
              >
                <div className="flex items-start gap-3 mb-3">
                  ...
                  {badge.unlocked && (
                    <span className="text-xs bg-kin-sage/20 text-kin-sage px-2 py-0.5 rounded-full font-medium shrink-0">
                      Fait
                    </span>
                  )}
                </div>
                {badge.total && (
                  <>
                    <div className="h-1.5 bg-muted rounded-full overflow-hidden">
                      <div
                        className={cn('h-full rounded-full transition-all duration-700', badge.unlocked ? 'bg-kin-sage' : 'bg-muted-foreground/30')}
