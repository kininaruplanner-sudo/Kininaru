// =====================================================================
// Kininaru Planner — Journal Studio Stickers
// =====================================================================
...
export const STICKERS: Sticker[] = [
  ...
  { id: 'clipboard', emoji: '📋', category: 'productivity' },
  ...
  { id: 'star-2', emoji: '🌟', category: 'productivity' },
  ...
  { id: 'moon', emoji: '🌙', category: 'nature' },
  { id: 'sun', emoji: '☀️', category: 'nature' },
  { id: 'cloud', emoji: '☁️', category: 'nature' },
  ...
  { id: 'star-10', emoji: '💫', category: 'stars' },
  { id: 'star-11', emoji: '🌈', category: 'stars' },
  { id: 'star-12', emoji: '☀️', category: 'stars' },

  // Plants
  { id: 'seedling', emoji: '🌱', category: 'plants' },
  { id: 'cactus', emoji: '🌵', category: 'plants' },
  { id: 'flower', emoji: '🌸', category: 'plants' },
  { id: 'tulip', emoji: '🌷', category: 'plants' },
  { id: 'rose', emoji: '🌹', category: 'plants' },
  { id: 'tree', emoji: '🌳', category: 'plants' },
  { id: 'leaf', emoji: '🍃', category: 'plants' },
  ...
  { id: 'mountain-2', emoji: '🏔️', category: 'travel' },
  { id: 'temple', emoji: '⛩️', category: 'travel' },
  { id: 'ferris-wheel', emoji: '🎡', category: 'travel' },
  { id: 'roller-coaster', emoji: '🎢', category: 'travel' },
  ...
  { id: 'ribbon', emoji: '🎀', category: 'celebration' },
  { id: 'medal', emoji: '🏅', category: 'celebration' },

  // Minimal
  { id: 'dot', emoji: '•', category: 'minimal' },
  { id: 'circle', emoji: '○', category: 'minimal' },
  { id: 'square', emoji: '□', category: 'minimal' },
  { id: 'triangle', emoji: '△', category: 'minimal' },
  { id: 'diamond', emoji: '◇', category: 'minimal' },
