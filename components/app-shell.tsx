  ...
  return (
    <div className="flex h-dvh overflow-hidden bg-background">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <header className="lg:hidden shrink-0 min-h-14 flex items-center gap-2 px-3 border-b border-border bg-card/95 backdrop-blur-sm sticky top-0 z-20 pt-[env(safe-area-inset-top)] pl-[max(0.75rem,env(safe-area-inset-left))] pr-[max(0.75rem,env(safe-area-inset-right))]">
          <Button
            variant="ghost"
            size="icon-sm"
